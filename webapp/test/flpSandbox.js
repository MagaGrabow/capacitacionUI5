		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Capacitacion UI5",
									"targetURL": "#capacitacionnamespacecapacitacionui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capacitacionnamespacecapacitacionui5-display": {
								"semanticObject": "capacitacionnamespacecapacitacionui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=capacitacionnamespace.capacitacionui5",
									"url": sap.ui.require.toUrl("capacitacionnamespace/capacitacionui5")
								}
							}
						}
					}
